...
*To grow their online community
...
*I want to provide information so that I can advertise the yoga classes the business offers.
*I want a call for action so that I can generate leads.
*I want to feature a logo and a welcome note so that I can raise my business brand awareness.
...
Hero banner section:
This section will feature a hero image with a welcome message and a call for action.
...
Wireframes
The wireframes were created using handwriting on paper and later on Balsamiq.
...
The About Me/Michelle,
The image shows the the yoga instructor of the business.
...
* #382f2f
* #fff
These neutral colors were selected to have a very easy, relaxed feel and simple to read.

Fonts
The website uses Balsamiq Sans as primary font, whilst the headings and subheadings use the secondary font Roboto, which pairs nicely with Open Sans. Both fonts were sourced from Google fonts.
...
https://github.com/Michelle1024/Yoga-with-Michelle-MS1
...
You can find all the steps to follow according your chosen method in this GitHub documentation on how to clone a repository.
